...
def get_app_directory():
    """Get the directory where the app is located (for data folder placement)"""
    if getattr(sys, 'frozen', False):
        # Running as PyInstaller bundle - executable location
        app_dir = Path(sys.executable).parent
        print(f"📦 Running as bundled app from: {app_dir}")
        return app_dir
    else:
        # Running as script - project root directory
...
def main():
    ...
    # Set working directory to app directory for consistent behavior
